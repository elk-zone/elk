...
export class PaginatorHttp<Entity, Params = undefined>
  implements akkoma.Paginator<Entity, Params>
{
  constructor(
    ...
    private readonly direction: akkoma.Direction = "next",
  ) {}
  ...
  getDirection(): akkoma.Direction {
    return this.direction;
  }

  setDirection(direction: akkoma.Direction): PaginatorHttp<Entity, Params> {
