...
<template>
  <footer p4 text-sm text-secondary-light flex="~ col">
    <div flex="~ gap2" items-center mb4>
      ...
      <CommonTooltip :content="$t('nav.zen_mode')">
        <button
          ...
          text-lg
          :class="
            getPreferences(userSettings, 'zenMode')
      ...
      <CommonTooltip :content="$t('magic_keys.dialog_header')">
        <button
          ...
          text-lg
          :aria-label="$t('magic_keys.dialog_header')"
    ...
    <div>
      ...
      &middot;
      <NuxtLink href="/m.webtoo.ls/@elk" target="_blank"> Mastodon </NuxtLink>
      &middot;
      <NuxtLink href="https://chat.elk.zone" target="_blank" external> Discord </NuxtLink>
      &middot;
      <NuxtLink href="https://github.com/elk-zone/elk" target="_blank" external> GitHub </NuxtLink>
    </div>
  </footer>
</template>
