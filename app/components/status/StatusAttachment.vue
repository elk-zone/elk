...
const shouldLoadAttachment = ref(
  isPreview || !getPreferences(userSettings.value, 'enableDataSaving'),
)
...
<template>
  <div relative ma flex :gap="isAudio ? '2' : ''">
    <template v-if="type === 'video'">
      <button type="button" relative @click="!shouldLoadAttachment ? loadAttachment() : null">
        <video
          ref="video"
          preload="none"
    ...
    <div :class="isAudio ? [] : ['absolute left-2', isVideo ? 'top-2' : 'bottom-2']" flex gap-col-2>
      <VDropdown
