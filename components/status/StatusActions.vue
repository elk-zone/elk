  ...
  <div flex justify-between items-center class="status-actions">
    ...
    <div flex-1>
      <StatusActionButton
        ...
        :color="getPreferences(userSettings, 'useStarFavoriteIcon') ? 'text-yellow' : 'text-rose'"
        :hover="getPreferences(userSettings, 'useStarFavoriteIcon') ? 'text-yellow' : 'text-rose'"
        :elk-group-hover="getPreferences(userSettings, 'useStarFavoriteIcon') ? 'bg-yellow/10' : 'bg-rose/10'"
        :icon="getPreferences(userSettings, 'useStarFavoriteIcon') ? 'i-ri:star-line' : 'i-ri:heart-3-line'"
        :active-icon="getPreferences(userSettings, 'useStarFavoriteIcon') ? 'i-ri:star-fill' : 'i-ri:heart-3-fill'"
