...
Elk PWA and favicon icons are generated from [Elk SVG Logo](https://github.com/elk-zone/elk/blob/main/public/logo.svg) via custom [script](https://github.com/elk-zone/elk/blob/main/scripts/generate-pwa-icons.ts), using [sharp](https://github.com/lovell/sharp/) and [sharp-io](https://github.com/ssnangua/sharp-ico) libraries:
- favicon.ico: transparent 64x64 32-bits icon
- pwa-64x64.png: transparent 64x64 8-bits icon (optimized from 32-bit color)
- pwa-192x192.png: transparent 192x192 8-bits icon (optimized from 32-bit color)
- pwa-512x512.png: transparent 512x512 8-bits icon (optimized from 32-bit color)
- maskable-icon.png: white 512x512 8-bits icon (optimized from 32-bit color)
- apple-touch-icon.png: white 180x180 8-bits icon (optimized from 32-bit color)
