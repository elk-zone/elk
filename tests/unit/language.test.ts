...
describe('language', () => {
  it('match language', () => {
    ...
    expect(matchLanguages(['zh-CN', 'zh-TW', 'en-US'], ['zh', 'en'])).toMatchInlineSnapshot(
      '"zh-CN"',
    )
    expect(matchLanguages(['zh-CN', 'zh-TW', 'en-US'], ['en', 'zh-CN'])).toMatchInlineSnapshot(
      '"en-US"',
    )
    expect(matchLanguages(['zh-CN', 'zh-TW', 'en-US'], ['zh-TW', 'en'])).toMatchInlineSnapshot(
      '"zh-TW"',
    )
